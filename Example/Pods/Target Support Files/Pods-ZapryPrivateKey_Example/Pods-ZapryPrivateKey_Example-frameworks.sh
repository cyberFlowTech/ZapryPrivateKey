...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/ZapryPrivateKey/ZapryPrivateKey.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/react-native-randombytes/react_native_randombytes.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/react-native-safe-area-context/react_native_safe_area_context.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/react-native-view-shot/react_native_view_shot.framework"
